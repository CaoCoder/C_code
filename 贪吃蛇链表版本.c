...
//#include <conio.h>
//
//#define ROW 50 //游戏区行数，代表纵坐标
//#define COL 100 //游戏区列数，代表横坐标
//
...
//	curInfo.bVisible = TRUE; //将光标设置为不可见
...
//	{
//		
//		i = rand() % ROW;//随机生成食物的纵坐标
//		j = rand() % COL;//随机生成食物的横坐标
